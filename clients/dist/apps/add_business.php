                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Add New Account</h1>
                        </div>
            ...
            <div class="container">
                        ...
                        <div class="card">
                            ...
                            <form name="myForm" id="myForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="lat" placeholder="Latitudes">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select name="states_of_nigeria" id="states_of_nigeria" class="form-control" required>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="header">
                                <h2>Social Information <small>Description text here...</small></h2>
                            </div>
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-sm-6">
    ...
    <script>
        ...
        $(document).ready(function () {
            function validateForm() {
                let hotel_name = document.forms["myForm"]["hotel_name"].value;
                let address = document.forms["myForm"]["address"].value;
                let phone = document.forms["myForm"]["phone"].value;

                let email = document.forms["myForm"]["email"].value;
                let rooms = document.forms["myForm"]["rooms"].value;

                if (hotel_name === "") {
                    Swal.fire({
                        title: "The Business Name Can Not Be Empty",
                        text: "Try Again!",
                        icon: "error"
                    });
                    return false;
                    ...
                    $.ajax({
                        ...
                        success: (data) => {
                            ...
                            if (data.trim() == "Success") {
                                Swal.fire({
                                    title: "success!",
                                    text: "Business Name Created, Please wait redirecting...!",
                                    icon: "success",
                                });
                                setTimeout(function () {
                                    var btn = $("#reset-btn");
