                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="navbar-logo">
                            ...
                            <a class="navbar-brand" href="dashboard.php"><img src="../assets/images/logo.svg" width="30" alt="Amaze"><span class="ml-2">Maxsomware</span></a>
                        </div>
                        <div class="d-flex justify-content-end justify-content-md-between align-items-center flex-grow-1">
                            <div class="d-flex align-items-center currently_maintain hidden-xs">
                                ...
                                <div class="dropdown">
                                    <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown">Doctor</button>
