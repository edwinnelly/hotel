...
<body>
	...
	<div id="main-wrapper">
			...
			<div class="container">
				<nav id="navigation" class="navigation navigation-landscape">
					<div class="nav-header">
						<a class="nav-brand static-show" href="index.php"><img src="logo.png" style="width: 100px;" class="logo" alt=""></a>
						<a class="nav-brand mob-show" href="home-5.html#"><img src="logo.png" class="logo" style="color: aqua;" alt=""></a>
						<div class="nav-toggle"></div>
						<div class="mobile_nav">
							<ul>
								<li class="currencyDropdown me-2">
									<a href="home-5.html#" class="nav-link" data-bs-toggle="modal" data-bs-target="#currencyModal"><span
											class="fw-medium">INR</span></a>
								</li>
								<li class="languageDropdown me-2">
									<a href="home-5.html#" class="nav-link" data-bs-toggle="modal" data-bs-target="#countryModal"><img
											src="assets/img/flag/flag.png" class="img-fluid" width="17" alt="Country"></a>
								</li>
								<li>
									<a href="home-5.html#" class="bg-light-primary text-primary rounded" data-bs-toggle="modal"
					...
					<div class="nav-menus-wrapper" style="transition-property: none;">
						...
						<ul class="nav-menu nav-menu-social align-to-right">
							<li class="currencyDropdown me-2">
								<a href="home-5.html#" class="nav-link" data-bs-toggle="modal" data-bs-target="#currencyModal"><span
										class="fw-medium">NGN</span></a>
							</li>
							<li class="languageDropdown me-2">
								<a href="home-5.html#" class="nav-link" data-bs-toggle="modal" data-bs-target="#countryModal"><img
										src="https://cdn2.iconfinder.com/data/icons/flags_gosquared/64/Nigeria_flat.png" class="img-fluid" width="17" alt="Country"></a>
							</li>
							<li class="list-buttons light">
								<a href="home-5.html#" data-bs-toggle="modal" data-bs-target="#login"><i
										class="fa-regular fa-circle-user fs-6 me-2"></i>Login / Register</a>
							</li>
						</ul>
					</div>
				</nav>
		...
		<!-- ============================ Hero Banner  Start================================== -->
		<div class="image-cover hero-header bg-white" style="background:url('https://images.pexels.com/photos/2885919/pexels-photo-2885919.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')no-repeat;" data-overlay="5">
			<div class="container">
								...
								<div class="touritem-middle position-relative p-3">
									<div class="touritem-flexxer">
										...
										<div class="touritem-centrio mt-4">
											<div class="d-block position-relative"><span class="label bg-light-success text-success">Free Cancellation Till 10 Aug 23</span></div>
			...
			<div class="container">
				...
				<div class="row justify-content-center gy-4 gx-3">
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<div class="pop-touritem">
							<a href="https://shreethemes.net/geotrip-live/geotrip/flight-search.html" class="card rounded-3 h-100 m-0">
								<div class="flight-thumb-wrapper">
									<div class="popFlights-item-overHidden">
			...
			<div class="container">
				...
				<div class="row justify-content-center gy-4 gx-3">
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<div class="cardCities cursor rounded-2">
							<div class="cardCities-image ratio ratio-4">
								<img src="https://preview.redd.it/abuja-nigeria-v0-mjd4ste6r20c1.jpg?width=1080&crop=smart&auto=webp&s=c2c1a741353376ac7a80018db5f59a2a51c7d267" class="img-fluid object-fit" alt="image">
							</div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<div class="cardCities cursor rounded-2">
							<div class="cardCities-image ratio ratio-4">
								<img src="https://weetracker.com/wp-content/uploads/2018/10/lagos.jpg" class="img-fluid object-fit" alt="image">
							</div>
			...
			<div class="container">
				...
				<div class="row justify-content-center g-4">
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="home-5.html#" class="d-block"><img src="assets/img/blog-1.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								<div class="d-flex align-items-center mb-1"><span
										class="label text-success bg-light-success">Destination</span></div>
								<h4 class="fw-bold fs-6 lh-base"><a href="home-5.html#" class="text-dark">Make Your Next Journey Delhi To Paris in
								...
								<a class="text-primary fw-medium" href="home-5.html#">Read More<i class="fa-solid fa-arrow-trend-up ms-2"></i></a>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="home-5.html#" class="d-block"><img src="assets/img/blog-2.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								<div class="d-flex align-items-center mb-1"><span
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="home-5.html#" class="d-block"><img src="assets/img/blog-3.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								<div class="d-flex align-items-center mb-1"><span
			...
			<div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
				<div class="modal-content" id="loginmodal">
					<div class="modal-header">
						...
						<a href="home-5.html#" class="text-muted fs-4" data-bs-dismiss="modal" aria-label="Close"><i
					...
					<div class="modal-body">
						...
						<div class="social-login py-4 px-2">
							<ul class="row align-items-center justify-content-between g-3 p-0 m-0">
								<li class="col"><a href="home-5.html#" class="square--60 border br-dashed rounded-2 full-width"><i
											class="fa-brands fa-facebook color--facebook fs-2"></i></a></li>
								<li class="col"><a href="home-5.html#" class="square--60 border br-dashed rounded-2"><i
				  ...
				  <div class="suggestedCurrencylist-wrap mb-4">
					...
					<div class="suggestedCurrencylists">
					  <ul
						...
						<li class="col">
						  <a class="selectCurrency" href="home-5.html#">
						...
						<li class="col">
						  <a class="selectCurrency active" href="home-5.html#">
				  ...
				  <div class="suggestedCurrencylist-wrap mb-4">
					...
					<div class="suggestedCurrencylists">
					  <ul
						...
						<li class="col">
						  <a class="selectCountry" href="home-5.html#">
						...
						<li class="col">
						  <a class="selectCountry active" href="home-5.html#">
		...
		<a id="back2Top" class="top-scroll" title="Back to top" href="home-5.html#"><i class="fa-solid fa-sort-up"></i></a>
