...
<body>
	...
	<div id="main-wrapper">
				...
				<div class="row justify-content-center align-items-center">
					...
					<div class="col-xl-9 col-lg-10 col-md-12 col-sm-12">
						<div class="position-relative text-center mb-5">
							<h1>Explore the world with Vioo. <span class="position-relative z-4"><span
							...
							<p class="fs-5 fw-light">Discover, plan a trip, and
									...
									<div class="row gy-3 gx-md-3 gx-sm-2">
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 position-relative">
											<div class="form-group border rounded-1 mb-0">
												<label>Where</label>
												<select class="goingto form-control border-0" name="leaving[]"
													multiple="multiple">
								...
								<div class="col-xl-4 col-lg-5 col-md-12">
									<div class="row gy-3 gx-md-3 gx-sm-2">
										...
										<div class="col-xl-4 col-lg-4 col-md-4 col-sm-5">
											<div class="form-group mb-0">
												<button type="button"
													class="btn btn-primary full-width rounded-1 fw-medium"><i
			...
			<div class="container">
				...
				<div class="row justify-content-center g-4">
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="home-5.html#" class="d-block"><img src="assets/img/blog-1.jpg"
							...
							<div class="blogGrid-caps pt-3">
								...
								<h4 class="fw-bold fs-6 lh-base"><a href="home-5.html#" class="text-dark">Make Your Next
								...
								<a class="text-primary fw-medium" href="home-5.html#">Read More<i
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="home-5.html#" class="d-block"><img src="assets/img/blog-2.jpg"
										class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								<div class="d-flex align-items-center mb-1"><span
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="home-5.html#" class="d-block"><img src="assets/img/blog-3.jpg"
										class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								<div class="d-flex align-items-center mb-1"><span
		...
		<div class="position-relative bg-cover bg-primary" style="background:url('assets/img/bg.jpg')no-repeat;"
			data-overlay="5">
			<div class="container">
				<div class="row align-items-center justify-content-between">
					<div class="col-xl-12 col-lg-12 col-md-12">
					...
					<div class="modal-body">
						...
						<div class="social-login py-4 px-2">
							<ul class="row align-items-center justify-content-between g-3 p-0 m-0">
								<li class="col"><a href="home-5.html#"
		...
		<a id="back2Top" class="top-scroll" title="Back to top" href="home-5.html#"><i
