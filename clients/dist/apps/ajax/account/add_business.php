...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertSql = "INSERT INTO business_accounts (business_name, address, phone, email_address, longitude, latitude, username, description, hotel_state, country, added_date, business_account, agent_id) VALUES (:hotel_name, :address, :phone, :email_address, :longitude, :latitude, :rooms, :description, :hotel_state, :country, :created, :hotel_account, :employeeid)";
