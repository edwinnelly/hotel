                ...
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12">
                        <div class="company_detail">
                            <h4 class="logo"><img class="mr-2" src="logo.png" alt="Logo" style="width:140px"> </h4>
                            <h3>Adventure <strong> Awaits </strong>,  every trip is a new story
                                waiting to be written.</h3>
                            <p>Discover the world's hidden gems, from breathtaking landscapes to vibrant cities, all
                                while experiencing the thrill of adventure. Our platform offers personalized
                                itineraries, seamless bookings, and expert recommendations to ensure your travel
                            ...
                            <div class="footer">
                                ...
                                <hr>
                                <p class="copyright font-12">Copyright 2024 © All Rights Reserved. Vioo Portal</p>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card-plain ml-auto">
                            ...
                            <span>Don't have an account? <a href="sign-up.html" class="link">Sign up</a></span>
                        </div>
                    </div>
                </div>
            </div>
