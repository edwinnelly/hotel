...
<head>
	...
	<title>Vioo - Tour & Travel Booking Agency | Vioo</title>
...
<body>
	...
	<div id="main-wrapper">
				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="car-detail.html#" class="text-primary">Home</a>
								</li>
								<li class="breadcrumb-item"><a href="car-detail.html#" class="text-primary">Cab</a></li>
								<li class="breadcrumb-item active" aria-current="page">New York-San Jose</li>
							</ol>
						</nav>
					</div>
							...
							<div class="crd-heaader d-md-flex align-items-center justify-content-between mb-3">
								<div class="crd-heaader-first">
									<div class="d-inline-flex align-items-center mb-1">
										<span class="label fw-medium bg-light-success text-success">25 Sep 2023</span>
									</div>
									<div class="d-block">
										<h4 class="mb-0">Camry, Accord - One Way</h4>
										<div class="">
											<p class="detail ellipsis-container fw-semibold">
												...
												<span class="separate ellipsis-item__normal"></span>
												<span class="ellipsis-item">4 Seats</span>
												<span class="separate ellipsis-item__normal"></span>
												<span class="ellipsis-item">Diesel Car</span>
											</p>
										</div>
									</div>
								</div>
								<div class="crd-heaader-last my-md-0 my-2">
									<div
										class="drix-wrap d-flex flex-column align-items-md-end align-items-start text-end">
										...
										<div class="drix-last">
											<span class="label bg-light-success text-success">Free Cancellation till 1
												hour of Pick up</label>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col-xl-8 col-lg-7 col-md-12">
										<div class="galleryGrid typeGrid_2 mb-lg-0 mb-3">
											<div class="galleryGrid__item relative d-flex">
												<a href="assets/img/car.jpg" data-lightbox="roadtrip"><img
														src="assets/img/car.jpg" alt="image"
											...
											<div class="galleryGrid__item position-relative">
												...
												<div class="position-absolute end-0 bottom-0 mb-3 me-3">
													<a href="assets/img/car.jpg" data-lightbox="roadtrip"
														class="btn btn-md btn-whites fw-medium text-dark"><i
															class="fa-solid fa-caret-right me-1"></i>16 More Photos</a>
												</div>
											</div>
										...
										<div class="card border br-dashed">
											<div class="card-header">
												<div
													...
													<div
														class="square--30 circle bg-light-primary text-primary flex-shrink-0">
														<i class="fa-solid fa-percent"></i>
													</div>
													<div class="crd-heady102Title lh-1 ps-2"><span
															class="text-sm fw-semibold text-dark text-uppercase lh-1 mb-0">Login
															not to get upto 20%
															lower price</span></div>
												</div>
												<div class="crd-heady103">
													<a href="car-detail.html#"
														class="btn btn-primary btn-sm px-4 fw-semibold text-uppercase">Login</a>
												</div>
											</div>
											<div class="card-body">
												<div class="d-block mb-3">
													<div class="d-flex align-items-center justify-content-start">
														<div class="text-dark fw-bold fs-3 me-2">$175</div>
														<div
															class="text-muted-2 fw-medium text-decoration-line-through me-2">
															US$300</div>
														<div class="text-warning fw-semibold">40% Off</div>
													</div>
													<div class="d-flex align-items-start justify-content-start">
														<div class="text-muted-2 text-md">inclusive of all taxes</div>
													</div>
												</div>
												<div class="d-block">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control"
															value="1674 Oak Drive Albany, New York">
													</div>

													<div class="form-group mb-4">
														<label class="form-label">Drop Address</label>
														<input type="text" class="form-control"
															value="1735 Sycamore Dallas, San Jose">
													</div>
													...
													<div class="form-group mb-3">
														<div class="d-flex align-items-center justify-content-between">
															<div
																...
																<div class="crd-heady102Title lh-1 ps-2"><span
																		class="text-sm fw-semibold text-dark text-uppercase lh-1 mb-0">oyofestive40
																		coupon
																		applied</span></div>
															</div>
															<div class="crd-heady103">
																<span
																	class="text-dark fw-semibold text-uppercase">-$1780</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group mb-2">
														<button type="button"
															class="btn btn-primary full-width fw-medium">Proceed For
															Booking</button>
													</div>
												</div>
											</div>
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div
							...
							<p class="text-light fw-semibold m-0"><i class="fa-solid fa-gift text-warning me-2"></i><a
									href="car-detail.html#" class="text-white text-decoration-underline">Login</a> or <a
									href="car-detail.html#" class="text-white text-decoration-underline">Register</a> to
								earn upto 100 coins (approx 1.72 US$)
								after check-out.
							<p>
						</div>
					</div>
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						...
						<div class="card mb-4">
							...
							<div class="card-body">
								<p class="mb-0">However, reviewers tend to be distracted by comprehensible content, say,
									a random text copied from a newspaper or the internet. The are likely to focus on
									the text, disregarding the layout and its elements. Besides, random text risks to be
									unintendedly humorous or offensive, an unacceptable risk in corporate environments.
									Lorem ipsum and its many variants have been employed since the early 1960ies, and
									quite likely since the sixteenth century.</p>
							</div>
						</div>
					</div>
						...
						<div class="card mb-4">
							...
							<div class="card-body">
								<ul class="row align-items-center p-0 g-3">
									<li class="col-md-6">
										<i class="fa-solid fa-check text-success me-2"></i>A fantastic experience at the
										Niagara
										Falls
									</li>
									<li class="col-md-6">
										<i class="fa-solid fa-check text-success me-2"></i>Wonderful experience at the
										Harborfront
									</li>
									<li class="col-md-6">
									...
									<li class="col-md-6">
										<i class="fa-solid fa-check text-success me-2"></i>Splendid experiences with the
										City
										tours.
									</li>
									<li class="col-md-6">
										<i class="fa-solid fa-check text-success me-2"></i>All led out world this music
										while
										asked.
									</li>
								</ul>
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="card mb-4">
							<div class="card-header">
								<h4 class="fs-5 mb-0">Cab Information</h4>
							</div>
							<div class="card-body">
								<div class="row align-items-start">

									<div class="col-xl-12 col-lg-12 col-md-12">
										<ul class="row align-items-center p-0 mb-0 gx-4 gx-lg-5">
											<li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<span class="fw-medium text-dark">User</span>
													<span class="fw-medium text-muted">4 Guest</span>
												</div>
											</li>
											<li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<span class="fw-medium text-dark">Modal</span>
													<span class="fw-medium text-muted">Maruti</span>
												</div>
											</li>
											<li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<span class="fw-medium text-dark">Make</span>
													<span class="fw-medium text-muted">2020</span>
												</div>
											</li>
											<li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<span class="fw-medium text-dark">Fuel</span>
													<span class="fw-medium text-muted">Diesel</span>
												</div>
											</li>
											<li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<span class="fw-medium text-dark">Mileage</span>
													<span class="fw-medium text-muted">16Km/L</span>
												</div>
											</li>
											<li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<span class="fw-medium text-dark">Version</span>
													<span class="fw-medium text-muted">2nd Top</span>
												</div>
											</li>
											<li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<span class="fw-medium text-dark">Condition</span>
													<span class="fw-medium text-muted">Full AC</span>
												</div>
											</li>
											<li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<span class="fw-medium text-dark">luggage</span>
													<span class="fw-medium text-muted">2 luggage bags</span>
												</div>
											</li>
										</ul>
									</div>
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="card mb-4">
							<div class="card-header">
								<h4 class="fs-5 mb-0">Inclusions & Exclusions</h4>
							</div>
							<div class="card-body">
								<div class="expott-info mb-4">
									<h5>Inclusions</h5>
									<ul class="row align-items-center p-0 g-3">
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>State tax
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i> Toll charge
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Driver Allowance
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Only one pickup
											and drop
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Inter-city
											Transfers
										</li>
									</ul>
								</div>
								<div class="expott-info">
									<h5>Exclusions</h5>
									<ul class="row align-items-center p-0 g-3">
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-danger me-2"></i>Fare beyond 600kms
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-danger me-2"></i>Airport entry
											charge
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-danger me-2"></i>Dinner
										</li>
									</ul>
								</div>
							</div>
												...
												<ul class="row align-items-center p-0 mb-0 gy-3 gx-4">
													<li class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
														<div class="revs-wraps">
															<div
																...
																<span
																	class="text-dark fw-semibold text-md">Dishes</span>
																<span class="text-dark fw-semibold text-md">8.7</span>
															</div>
															<div class="progress " role="progressbar"
																aria-label="Example" aria-valuenow="87"
													...
													<li class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
														<div class="revs-wraps">
															<div
																class="revs-wraps-flex d-flex align-items-center justify-content-between mb-1">
																<span
																	class="text-dark fw-semibold text-md">Swimming</span>
																<span class="text-dark fw-semibold text-md">9.2</span>
															</div>
															<div class="progress " role="progressbar"
																aria-label="Example" aria-valuenow="92"
																aria-valuemin="0" aria-valuemax="100"
																style="height: 7px">
													...
													<li class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
														<div class="revs-wraps">
															...
															<div class="progress " role="progressbar"
																aria-label="Example" aria-valuenow="88"
																aria-valuemin="0" aria-valuemax="100"
																style="height: 7px">
													...
													<li class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
														<div class="revs-wraps">
															<div
																class="revs-wraps-flex d-flex align-items-center justify-content-between mb-1">
																<span
																	class="text-dark fw-semibold text-md">Location</span>
																<span class="text-dark fw-semibold text-md">8.9</span>
															</div>
															<div class="progress " role="progressbar"
																aria-label="Example" aria-valuenow="89"
																aria-valuemin="0" aria-valuemax="100"
																style="height: 7px">
																<div class="progress-bar bg-primary" style="width: 89%">
																</div>
															</div>
														</div>
													</li>
													<li class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
														<div class="revs-wraps">
															<div
																class="revs-wraps-flex d-flex align-items-center justify-content-between mb-1">
																<span
																	class="text-dark fw-semibold text-md">Services</span>
																<span class="text-dark fw-semibold text-md">9.2</span>
															</div>
															<div class="progress " role="progressbar"
																aria-label="Example" aria-valuenow="92"
													...
													<li class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
														<div class="revs-wraps">
															<div
																class="revs-wraps-flex d-flex align-items-center justify-content-between mb-1">
																<span
																	class="text-dark fw-semibold text-md">Cleanliness</span>
																<span class="text-dark fw-semibold text-md">8.6</span>
															</div>
															<div class="progress " role="progressbar"
																aria-label="Example" aria-valuenow="86"
																aria-valuemin="0" aria-valuemax="100"
																style="height: 7px">
										...
										<div class="gstRevws-groups">
											...
											<div
												...
												<div class="single-gstRevws-caps ps-3">
													<div
														...
														<div class="dfls-arrios"><span class="text-muted text-md">10
																July 2023</span></div>
													</div>
													<div class="dfls-secription">
														<p class="mb-0">In a free hour, But in certain circumstances and
															owing to the claims of
															duty or the obligations of business when our power of choice
															is untrammelled and when
											...
											<div class="show-morerewsbox mb-3">
												<div class="text-center" role="alert">
													<a href="car-detail.html#" class="fw-medium text-primary">Load More
														Guest Reviews<i class="fa-solid fa-caret-down ms-2"></i></a>
												</div>
											</div>
											...
											<div class="sbms-rewsbox">
												<div class="alert alert-success text-center" role="alert">
													Login your account to submit reviews <a href="car-detail.html#"
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="row align-items-start justify-content-between gx-3">
							<div class="col-xl-3 col-lg-4 col-md-4">
								...
								<div class="position-relative mb-4">
									<button class="btn btn-md btn-primary fw-medium" type="button">Submit
										Request</button>
								</div>
							</div>
								...
								<div class="accordion accordion-flush" id="accordionFlushExample">
									<div class="accordion-item">
										...
										<div id="flush-collapseOne" class="accordion-collapse collapse"
											...
											<div class="accordion-body">In a professional context it often happens that
												private or corporate
												clients corder a publication to be made and presented with the actual
												content still not being
												ready. Think of a news blog that's filled with content hourly on the day
												of going live. However,
												reviewers tend to be distracted by comprehensible content, say, a random
												text copied from a
				...
				<div class="row align-items-center justify-content-between mb-3">
					...
					<div class="col-4">
						<div class="text-end grpx-btn">
							<a href="car-detail.html#" class="btn btn-light-primary btn-md fw-medium">More<i
						...
						<div class="main-carousel cols-3 arrow-hide">
							...
							<div class="carousel-cell">
								<div class="pop-touritem">
									<a href="car-detail.html#" class="card rounded-3 border m-0">
											...
											<div class="trsms-foots mt-4">
												<div class="flts-flex d-flex align-items-end justify-content-between">
													<div class="flts-flex-strat">
														<div class="d-flex align-items-center justify-content-start">
															<span class="label bg-light-danger text-danger">15%
																Off</span>
														</div>
													...
													<div class="flts-flex-end">
														<div class="row align-items-center justify-content-end gx-2">
															<div class="col-auto text-start text-md-end">
																<div class="text-md text-dark fw-medium">Exceptional
																</div>
																<div class="text-md text-muted-2">3,014 reviews</div>
															</div>
															<div class="col-auto">
																<div class="square--40 rounded-2 bg-primary text-light">
																	4.8</div>
															</div>
														</div>
													</div>
			...
			<div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
				<div class="modal-content" id="loginmodal">
					<div class="modal-header">
						...
						<a href="car-detail.html#" class="text-muted fs-4" data-bs-dismiss="modal" aria-label="Close"><i
							...
							<div class="suggestedCurrencylist-wrap mb-4">
								...
								<div class="suggestedCurrencylists">
									<ul
										...
										<li class="col">
											<a class="selectCurrency" href="car-detail.html#">
										...
										<li class="col">
											<a class="selectCurrency active" href="car-detail.html#">
							...
							<div class="suggestedCurrencylist-wrap mb-4">
								...
								<div class="suggestedCurrencylists">
									<ul
										...
										<li class="col">
											<a class="selectCountry" href="car-detail.html#">
										...
										<li class="col">
											<a class="selectCountry active" href="car-detail.html#">
		...
		<a id="back2Top" class="top-scroll" title="Back to top" href="car-detail.html#"><i
