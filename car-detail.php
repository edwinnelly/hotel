...
<body>
	...
	<div id="main-wrapper">
				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="car-detail.html#" class="text-primary">Home</a></li>
								...
								<div class="crd-heaader-last my-md-0 my-2">
									<div class="drix-wrap d-flex flex-column align-items-md-end align-items-start text-end">
										<div class="drix-first d-flex align-items-center text-end mb-2">
											<a href="car-detail.html#" class="bg-light-info text-info rounded-1 fw-medium text-sm px-3 py-2 lh-base"><i
										...
										<div class="drix-last">
											<span class="label bg-light-success text-success">Free Cancellation till 1 hour of Pick up</label>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col-xl-8 col-lg-7 col-md-12">
										<div class="galleryGrid typeGrid_2 mb-lg-0 mb-3">
											<div class="galleryGrid__item relative d-flex">
												<a href="assets/img/car.jpg" data-lightbox="roadtrip"><img src="assets/img/car.jpg"
										...
										<div class="card border br-dashed">
											<div class="card-header">
												<div class="crd-heady102 d-flex align-items-center justify-content-start">
													<div class="square--30 circle bg-light-primary text-primary flex-shrink-0"><i
															class="fa-solid fa-percent"></i></div>
													<div class="crd-heady102Title lh-1 ps-2"><span
															class="text-sm fw-semibold text-dark text-uppercase lh-1 mb-0">Login not to get upto 20%
															lower price</span></div>
												</div>
												<div class="crd-heady103">
													<a href="car-detail.html#" class="btn btn-primary btn-sm px-4 fw-semibold text-uppercase">Login</a>
												</div>
											</div>
											<div class="card-body">
												<div class="d-block mb-3">
													<div class="d-flex align-items-center justify-content-start">
														...
														<div class="text-muted-2 fw-medium text-decoration-line-through me-2">US$300</div>
												...
												<div class="d-block">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" value="1674 Oak Drive Albany, New York">
													</div>

													<div class="form-group mb-4">
														<label class="form-label">Drop Address</label>
														<input type="text" class="form-control" value="1735 Sycamore Dallas, San Jose">
													</div>

													<div class="form-group mb-3">
														<div class="d-flex align-items-center justify-content-between">
															<div class="crd-heady102 d-flex align-items-center justify-content-start">
																<div class="square--30 circle bg-light-success text-success"><i
																		class="fa-solid fa-percent"></i></div>
																<div class="crd-heady102Title lh-1 ps-2"><span
																		class="text-sm fw-semibold text-dark text-uppercase lh-1 mb-0">oyofestive40 coupon
																		applied</span></div>
															</div>
															<div class="crd-heady103">
																<span class="text-dark fw-semibold text-uppercase">-$1780</span>
															</div>
														</div>
													</div>

													<div class="form-group mb-2">
														<button type="button" class="btn btn-primary full-width fw-medium">Proceed For Booking</button>
													</div>
												</div>
											</div>
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="d-flex align-items-center justify-content-start py-3 px-3 rounded-2 bg-success mb-4">
							<p class="text-light fw-semibold m-0"><i class="fa-solid fa-gift text-warning me-2"></i><a href="car-detail.html#"
									class="text-white text-decoration-underline">Login</a> or <a href="car-detail.html#"
							...
							<div class="card-body">
								<div class="expott-info mb-4">
									...
									<ul class="row align-items-center p-0 g-3">
										...
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Only one pickup and drop
										</li>
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-success me-2"></i>Inter-city Transfers
										</li>
									</ul>
								</div>
								<div class="expott-info">
									...
									<ul class="row align-items-center p-0 g-3">
										...
										<li class="col-md-6">
											<i class="fa-regular fa-circle-dot text-danger me-2"></i>Airport entry charge
										</li>
										<li class="col-md-6">
										...
										<div class="gstRevws-groups">
											...
											<div class="show-morerewsbox mb-3">
												<div class="text-center" role="alert">
													<a href="car-detail.html#" class="fw-medium text-primary">Load More Guest Reviews<i
											...
											<div class="sbms-rewsbox">
												<div class="alert alert-success text-center" role="alert">
													Login your account to submit reviews <a href="car-detail.html#" class="text-dark">Login</a>
												</div>
											</div>
					...
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-xl-6 col-lg-6 col-md-6">
							<ul class="p-0 d-flex justify-content-start justify-content-md-end text-start text-md-end m-0">
								<li><a href="car-detail.html#">Terms of services</a></li>
								<li class="ms-3"><a href="car-detail.html#">Privacy Policies</a></li>
								<li class="ms-3"><a href="car-detail.html#">Cookies</a></li>
							</ul>
						</div>
					...
					<div class="modal-body">
						...
						<div class="social-login py-4 px-2">
							<ul class="row align-items-center justify-content-between g-3 p-0 m-0">
								<li class="col"><a href="car-detail.html#" class="square--60 border br-dashed rounded-2 full-width"><i
											class="fa-brands fa-facebook color--facebook fs-2"></i></a></li>
								<li class="col"><a href="car-detail.html#" class="square--60 border br-dashed rounded-2"><i
		...
		<a id="back2Top" class="top-scroll" title="Back to top" href="car-detail.html#"><i class="fa-solid fa-sort-up"></i></a>
